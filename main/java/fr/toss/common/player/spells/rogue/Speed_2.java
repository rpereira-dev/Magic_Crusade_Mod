...
public class Speed_2 extends Spell {
	...
	{
		return I18n.format("spell.rogue.speed");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[2];
		str[0] = "You get a movespeed and ";
		str[1] = "jump boost for 6 seconds";
	...
	public static void playEffect(double x, double y, double z)
	{
		...
		for (int i = 0; i < 250; i++)
        {
    		...
    		particles = new EntityFX_Colored(world, x, y, z, a, -b, c, 0.5f, 5.0f, 0.0f, 1.5f);
