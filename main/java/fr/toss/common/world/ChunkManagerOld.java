...
public class ChunkManagerOld extends WorldChunkManager
{
    ...
    private static OldNoiseGeneratorOctaves2 noiseOctave1;
    private static OldNoiseGeneratorOctaves2 noiseOctave2;
    private static OldNoiseGeneratorOctaves2 noiseOctave3;
    ...
    public ChunkManagerOld(World par1World)
    {
        this();
        long seed = par1World.getSeed();
        
        generateBiomeLookup();
        noiseOctave1 = new OldNoiseGeneratorOctaves2(new Random(seed * 9871L), 4);
        noiseOctave2 = new OldNoiseGeneratorOctaves2(new Random(seed * 39811L), 4);
        noiseOctave3 = new OldNoiseGeneratorOctaves2(new Random(seed * 0x84a59L), 2);
    }    
	...
	public static double[] getColdTemperatures(double ad[], int i, int j, int k, int l)
    {
        ...
        ad = noiseOctave1.func_4112_a(ad, i, j, k, l, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
        field_4196_c = noiseOctave3.func_4112_a(field_4196_c, i, j, k, l, 0.25D, 0.25D, 0.58823529411764708D);
        int i1 = 0;
    ...
    {		
		...
		temperature = noiseOctave1.func_4112_a(temperature, par1, par2, par3, par3, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
		humidity = noiseOctave2.func_4112_a(humidity, par1, par2, par3, par3, 0.05000000074505806D, 0.05000000074505806D, 0.33333333333333331D);
		field_4196_c = noiseOctave3.func_4112_a(field_4196_c, par1, par2, par3, par3, 0.25D, 0.25D, 0.58823529411764708D);
		int i1 = 0;
    ...
    public int getBetaBiomes(float f, float f1) 
    {
		...
		if(f < 0.1F)
		{
			return BiomsList.FOREST_FROZEN.biomeID; 
		}
		if(f1 < 0.2F)
		{
			if(f < 0.5F)
			...
			{
				return BiomsList.FOREST_ROOFED.biomeID; 
			}
		}
		if(f1 > 0.5F && f < 0.7F)
		{
			return BiomsList.FOREST_MAGIC.biomeID; 
		}
		if(f < 0.5F)
		{
			return BiomsList.FOREST_FROZEN.biomeID; 
