...
public class WorldGenBigTreesDim extends WorldGenAbstractTree
{
    /**
    ...
    void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_)
    {
        ...
        for (int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte)1, BlockRegister.LEAVES);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.func_150530_a(aint, aint1, BlockRegister.LOGS1);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, BlockRegister.LOGS1);
            }
        }
    }
