...
public class EntitySlimeFrozen extends EntityLiving implements IMob
{
    ...
    public EntitySlimeFrozen(World p_i1742_1_)
    {
        super(p_i1742_1_);
    ...
    protected EntitySlimeFrozen createInstance()
    {
        return new EntitySlimeFrozen(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                EntitySlimeFrozen entityslime = this.createInstance();
